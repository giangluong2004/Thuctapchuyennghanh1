      ...
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            ...
            <p class="fs-4">SẠCH TỪ TÂM - AN TOÀN TỪ SẢN PHẨM </p>
            <div class="d-flex gap-3">
              <a href="#" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Mua Sắm </a>
            ...
            <div class="row my-5">
              <div class="col">
                <div class="row text-dark">
                  ...
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Các loại sản phẩm</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
              ...
              <div class="col">
                <div class="row text-dark">
                  ...
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Vị trí cửa hàng</p></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Tươi từ trang trại</h5>
          ...
          <div class="col">
            <div class="card border-0 bg-danger rounded-0 p-4 text-light">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Giao hàng miễn phí</h5>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipi elit.</p>
                  </div>
                </div>
              </div>
